...
class EventExtractionResult(SequenceTaggingResult):
    """Store and calculate result class(custom), inherit from SequenceTaggingResult.
    ...
    def __init__(self, task_name: str, id2label: dict, max_seq_len: int):
        super(EventExtractionResult, self).__init__(task_name=task_name)
